...
namespace GameOfRevenge.Common.Models.Boost
{
    ...
    public class BoostTypeRel : IReadOnlyBoostTypeRel
    {
        public BoostTypeTable Info { get; set; }
        public List<BoostTable> Values { get; set; }

        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IReadOnlyBoostTypeTable IReadOnlyBoostTypeRel.Info => Info;
